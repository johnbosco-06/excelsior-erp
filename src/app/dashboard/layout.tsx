...
const NAV_HOD = [
  ...
  { icon: Clock,           label: "Day Analysis",   href: "/dashboard/attendance-analysis" },
  ...
  { icon: Award,           label: "NAAC / NBA",     href: "/dashboard/naac" },
  ...
  { icon: Award2,          label: "Placements",     href: "/dashboard/placements" },
